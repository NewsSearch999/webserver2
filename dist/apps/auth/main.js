...
const user_entity_1 = __webpack_require__(/*! ./users/user.entity */ "./apps/auth/src/users/user.entity.ts");
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof user_entity_1.User !== "undefined" && user_entity_1.User) === "function" ? _b : Object, typeof (_c = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _c : Object]),
...
], User.prototype, "deletedType", void 0);
exports.User = User;
...
const users_service_1 = __webpack_require__(/*! ./users.service */ "./apps/auth/src/users/users.service.ts");
const user_entity_1 = __webpack_require__(/*! ./user.entity */ "./apps/auth/src/users/user.entity.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
...
let UsersService = class UsersService {
    ...
    async createUser(request) {
        ...
        if (exists)
            return { ok: false, msg: '이미 가입된 아이디 입니다.' };
